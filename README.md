...
**Feature Engineering:** Added _Total Revenue_ column (Quantity × Unit Price), created _Year-Month_ for seasonality analysis
...
## Acknowledgments
This project is based on the original dataset provided by Mehmet Tahir Aslan on Kaggle 
